function turncube(){
    const canvas = document.querySelector("#turncube");
...
function moveX(){
    const canvas = document.querySelector("#moveX");
    const gl = canvas.getContext('webgl', { preserveDrawingBuffer: true });
...
function moveY(){
    const canvas = document.querySelector("#moveY");
    const gl = canvas.getContext('webgl', { preserveDrawingBuffer: true });
...
function zoom(){
    const canvas = document.querySelector("#zoom");
    const gl = canvas.getContext('webgl', { preserveDrawingBuffer: true });
